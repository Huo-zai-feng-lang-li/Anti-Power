...
<p align="center">
  <a href="https://github.com/Huo-zai-feng-lang-li/Antigravity-Power-Pro/releases">
    <img src="https://img.shields.io/badge/version-v2.6.86-gold?style=flat-square" alt="版本">
...
| :---------- | :----------------- | :--------- | :--------------------------------------------------------------------------------------------------- |
| **v2.6.86** | v1.23.2 / Windsurf | 2026-08-23 | **增强**: 新增 Mermaid 语法清洗与自动容错管道（修复甘特图等非标语法）；重构防抖窗口根治长列表滚动卡顿与掉帧 | ✅ 推荐 |
